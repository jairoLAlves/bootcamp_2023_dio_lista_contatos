                    ...
                    child: Column(
                      ...
                      children: [
                        ValueListenableBuilder(
                            valueListenable: contatoEditController.photo,
                            builder: (_, image, __) =>
                                largeAvatar(image: image)),
                        TextButton(
                          onPressed: () async {
                            PhotoIn? photoIn = await showMenu<PhotoIn>(
                                context: context,
                  ...
                  Form(
                    ...
                    child: Container(
                      child: Column(
                        ...
                        children: <Widget>[
                          textField(
                            validator: contatoEditController.validatorName,
                            controller: contatoEditController.nomeController,
                          ...
                          textField(
                            controller:
                                contatoEditController.sobreNomeController,
                          ...
                          InternationalPhoneNumberInput(
                            ...
                            initialValue: contatoEditController.number,
                            textFieldController:
                                contatoEditController.telController,
                            formatInput: true,
                            keyboardType: const TextInputType.numberWithOptions(
                                signed: true, decimal: true),
                            inputBorder: const OutlineInputBorder(),
                            onSaved: (PhoneNumber number) {
                              contatoEditController.number = number;
                            },
                          ),
                        ],
                      ),
